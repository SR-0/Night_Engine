...
void Setup::setupCore()
{
	...
	*m_RenderLayerCount = 5; // for pong 5 is more than enough
...
{
	m_Texts->get("TextTitleID").setFont(			m_Fonts->get("FontMain")	);
	m_Texts->get("TextTitleVersion").setFont(		m_Fonts->get("FontMain")	);
	m_Texts->get("TextTitlePlay").setFont(			m_Fonts->get("FontMain")	);
	m_Texts->get("TextTitleGameMode").setFont(		m_Fonts->get("FontMain")	);
	m_Texts->get("TextTitleScreenMode").setFont(	m_Fonts->get("FontMain")	);
	m_Texts->get("TextTitleResolution").setFont(	m_Fonts->get("FontMain")	);
	m_Texts->get("TextTitleQuit").setFont(			m_Fonts->get("FontMain")	);
	m_Texts->get("TextTitleDetails").setFont(		m_Fonts->get("FontMain")	);
	m_Texts->get("TextOK").setFont(					m_Fonts->get("FontMain")	);
	m_Texts->get("TextCancel").setFont(				m_Fonts->get("FontMain")	);
	m_Texts->get("TextClose").setFont(				m_Fonts->get("FontMain")	);
	m_Texts->get("TextMessage").setFont(			m_Fonts->get("FontMain")	);
	m_Texts->get("TextPlayerLeftID").setFont(		m_Fonts->get("FontMain")	);
	m_Texts->get("TextPlayerLeftScore").setFont(	m_Fonts->get("FontMain")	);
	m_Texts->get("TextPlayerLeftRank").setFont(		m_Fonts->get("FontMain")	);
	m_Texts->get("TextPlayerRightID").setFont(		m_Fonts->get("FontMain")	);
	m_Texts->get("TextPlayerRightScore").setFont(	m_Fonts->get("FontMain")	);
	m_Texts->get("TextPlayerRightRank").setFont(	m_Fonts->get("FontMain")	);
	...
	m_Texts->get("TextOK").setCharacterSize(				12	);
	m_Texts->get("TextCancel").setCharacterSize(			12	);
	m_Texts->get("TextClose").setCharacterSize(				12	);
	...
	m_Texts->get("TextOK").setScale(				*m_Scale	);
	m_Texts->get("TextCancel").setScale(			*m_Scale	);
	m_Texts->get("TextClose").setScale(				*m_Scale	);
	...
	m_Texts->get("TextOK").setLetterSpacing(				2	);
	m_Texts->get("TextCancel").setLetterSpacing(			2	);
	m_Texts->get("TextClose").setLetterSpacing(				2	);
	...
	m_Texts->get("TextTitleScreenMode").setString(	(m_Resolution->x == sf::VideoMode::getDesktopMode().width ? "Fullscreen" : "Borderless"));
	...
	m_Texts->get("TextOK").setString(				"Ok");
	m_Texts->get("TextCancel").setString(			"Cancel");
	m_Texts->get("TextClose").setString(			"X");
	...
	m_Texts->get("TextOK").setPosition(					(3000	*	m_Scale->x)	,	(2000	*	m_Scale->y)		);
	m_Texts->get("TextCancel").setPosition(				(3000	*	m_Scale->x)	,	(2000	*	m_Scale->y)		);
	m_Texts->get("TextClose").setPosition(				(3000	*	m_Scale->x)	,	(2000	*	m_Scale->y)		);
	...
	m_Texts->get("TextOK").setRenderEnabled(				false	);
	m_Texts->get("TextCancel").setRenderEnabled(			false	);
	m_Texts->get("TextClose").setRenderEnabled(				false	);
	...
	m_Texts->get("TextOK").setRenderLayer(					3	);
	m_Texts->get("TextCancel").setRenderLayer(				3	);
	m_Texts->get("TextClose").setRenderLayer(				3	);
...
void Setup::setupRectangleShapes()
{
	...
	m_RectangleShapes->get("ButtonOk").setTexture(			nullptr									);
	m_RectangleShapes->get("ButtonApply").setTexture(		nullptr									);
	m_RectangleShapes->get("ButtonCancel").setTexture(		nullptr									);
	m_RectangleShapes->get("ButtonResume").setTexture(		nullptr									);
	...
	m_RectangleShapes->get("PlayerLeft").setTexture(		&m_Textures->get("TexturePongBall")		);
	m_RectangleShapes->get("PlayerRight").setTexture(		&m_Textures->get("TexturePlayerLeft")	);
	m_RectangleShapes->get("PongBall").setTexture(			&m_Textures->get("TexturePlayerRight")	);
	...
	m_RectangleShapes->get("ButtonOk").setSize(			sf::Vector2f(	m_Resolution->x		,	25						)	);
	m_RectangleShapes->get("ButtonApply").setSize(		sf::Vector2f(	m_Resolution->x		,	25						)	);
	m_RectangleShapes->get("ButtonCancel").setSize(		sf::Vector2f(	m_Resolution->x		,	25						)	);
	m_RectangleShapes->get("ButtonResume").setSize(		sf::Vector2f(	m_Resolution->x		,	25						)	);
	...
	m_RectangleShapes->get("PlayerLeft").setSize(		sf::Vector2f(	m_Textures->get("TexturePongBall").getSize()	)	);
	m_RectangleShapes->get("PlayerRight").setSize(		sf::Vector2f(	m_Textures->get("TexturePlayerLeft").getSize()	)	);
	m_RectangleShapes->get("PongBall").setSize(			sf::Vector2f(	m_Textures->get("TexturePlayerRight").getSize()	)	);
	...
	m_RectangleShapes->get("ButtonOk").setOrigin(			sf::Vector2f(	0														,	0																												)	);
	m_RectangleShapes->get("ButtonApply").setOrigin(		sf::Vector2f(	0														,	0																												)	);
	m_RectangleShapes->get("ButtonCancel").setOrigin(		sf::Vector2f(	0														,	0																												)	);
	m_RectangleShapes->get("ButtonResume").setOrigin(		sf::Vector2f(	0														,	0																												)	);
	...
	m_RectangleShapes->get("PlayerLeft").setOrigin(			sf::Vector2f(	m_Textures->get("TexturePongBall").getSize().x		/ 2	,	m_Textures->get("TexturePongBall").getSize().y		/ 2		)	);
	m_RectangleShapes->get("PlayerRight").setOrigin(		sf::Vector2f(	m_Textures->get("TexturePlayerLeft").getSize().x	/ 2	,	m_Textures->get("TexturePlayerLeft").getSize().y	/ 2		)	);
	m_RectangleShapes->get("PongBall").setOrigin(			sf::Vector2f(	m_Textures->get("TexturePlayerRight").getSize().x	/ 2	,	m_Textures->get("TexturePlayerRight").getSize().y	/ 2		)	);
	...
	m_RectangleShapes->get("ButtonOk").setScale(			*m_Scale	);
	m_RectangleShapes->get("ButtonApply").setScale(			*m_Scale	);
	m_RectangleShapes->get("ButtonCancel").setScale(		*m_Scale	);
	m_RectangleShapes->get("ButtonResume").setScale(		*m_Scale	);
	...
	m_RectangleShapes->get("ButtonOk").setPosition(			sf::Vector2f(	0						*	m_Scale->x	,	0							* m_Scale->y	)	);
	m_RectangleShapes->get("ButtonApply").setPosition(		sf::Vector2f(	0						*	m_Scale->x	,	0							* m_Scale->y	)	);
	m_RectangleShapes->get("ButtonCancel").setPosition(		sf::Vector2f(	0						*	m_Scale->x	,	0							* m_Scale->y	)	);
	m_RectangleShapes->get("ButtonResume").setPosition(		sf::Vector2f(	0						*	m_Scale->x	,	0							* m_Scale->y	)	);
	...
	m_RectangleShapes->get("ButtonOk").setFillColor(			sf::Color::Black	);
	m_RectangleShapes->get("ButtonApply").setFillColor(			sf::Color::Black	);
	m_RectangleShapes->get("ButtonCancel").setFillColor(		sf::Color::Black	);
	m_RectangleShapes->get("ButtonResume").setFillColor(		sf::Color::Black	);
	...
	m_RectangleShapes->get("ButtonOk").setOpacity(			0	);
	m_RectangleShapes->get("ButtonApply").setOpacity(		0	);
	m_RectangleShapes->get("ButtonCancel").setOpacity(		0	);
	m_RectangleShapes->get("ButtonResume").setOpacity(		0	);
	...
	m_RectangleShapes->get("ButtonOk").setSpeed(			sf::Vector2f(		0.0f	,	0.0f	)	);
	m_RectangleShapes->get("ButtonApply").setSpeed(			sf::Vector2f(		0.0f	,	0.0f	)	);
	m_RectangleShapes->get("ButtonCancel").setSpeed(		sf::Vector2f(		0.0f	,	0.0f	)	);
	m_RectangleShapes->get("ButtonResume").setSpeed(		sf::Vector2f(		0.0f	,	0.0f	)	);
	...
	m_RectangleShapes->get("ButtonOk").setRenderEnabled(			false	);
	m_RectangleShapes->get("ButtonApply").setRenderEnabled(			false	);
	m_RectangleShapes->get("ButtonCancel").setRenderEnabled(		false	);
	m_RectangleShapes->get("ButtonResume").setRenderEnabled(		false	);
	...
	m_RectangleShapes->get("PlayerLeft").setRenderEnabled(			false	);
	m_RectangleShapes->get("PlayerRight").setRenderEnabled(			false	);
	m_RectangleShapes->get("PongBall").setRenderEnabled(			false	);
	...
	m_RectangleShapes->get("ButtonOk").setRenderLayer(			2	);
	m_RectangleShapes->get("ButtonApply").setRenderLayer(		2	);
	m_RectangleShapes->get("ButtonCancel").setRenderLayer(		2	);
	m_RectangleShapes->get("ButtonResume").setRenderLayer(		2	);
	m_RectangleShapes->get("ButtonQuit").setRenderLayer(		2	);
	m_RectangleShapes->get("MessageBanner").setRenderLayer(		2	);
	m_RectangleShapes->get("SplashScreen").setRenderLayer(		5	);
